    ...
    <View>
      <TextInput
        ...
        style={[
          ...
          {
            paddingLeft:
              text === "Price" || text === "Buy Tickets Link" ? 10 : 50,
            width: text === "Price" ? 104 : 319,
      ...
      >
        ...
        {text === "Page" && (
          <Image
            style={{ marginRight: 5, width: 20, height: 20 }}
            source={require("../assets/images/fbPage.png")}
            resizeMode="contain"
          />
        )}
        {text === "Group" && (
          <Image
            style={{ marginRight: 5, width: 20, height: 20 }}
            source={require("../assets/images/fbGroup.png")}
            resizeMode="contain"
          />
        )}
        {text === "Meetup" && (
        ...
        <Text
          style={
            ...
            text !== "Other Link"
              ? [
                  styles.inputText,
                  { color: !state && pressed ? "red" : "black" },
                ]
              : text === "Page" || text === "Group"
              ? [
                  styles.inputTextSocial,
                  { color: !state && pressed ? "red" : "#3b5998" },
                ]
              : text === "Meetup"
              ? [
                  styles.inputTextSocial,
                  { color: !state && pressed ? "red" : "#ed1c40" },
                ]
              : text === "Telegram"
              ? [
                  styles.inputTextSocial,
      ...
      {text === "Email" ? (
        <View style={styles.imageSquare}>
          <Arobase width={30} height={30} />
        </View>
      ) : text === "First Name" ||
        text === "Last Name" ||
        text === "Nickname, Brand or User name" ? (
        <View style={styles.imageSquare}>
          <TextFrame width={30} height={30} />
        </View>
      ) : text === "City" ? (
        <View style={styles.imageSquare}>
          <City width={30} height={30} />
        </View>
      ) : text === "Birthday" ? (
        <View style={styles.imageSquare}>
          <Birthday width={30} height={30} />
        </View>
      ) : (
