        ...
        <View style={styles.center}>
          <View style={styles.temporaryUserIcon}>
            <View style={styles.imgContainer}>
              <Image style={styles.img} source={{ uri: profilData.avatar }} />
          ...
          <View
            style={[
              ...
              {
                width: editProfile.step1.nativeLanguage.length * 9,
                top: !city && errorMsg ? 373 : 426,
              },
            ]}
          >
            <Text
            ...
            >
              {editProfile.step1.nativeLanguage}
            </Text>
          </View>
        </View>
            ...
            onPress={() => {
                ...
                for (let i = 0; i < firstName.length; i++) {
                  if (
                    !(
                      ...
                      (firstName.charCodeAt(i) > 96 &&
                        firstName.charCodeAt(i) < 123)
                    )
                  ) {
                    setError(
                      "Fields must not contain numbers or special characters"
                    );
              ...
              if (!nickName) {
                ...
                for (let i = 0; i < nickName.length; i++) {
                  if (
                    !(
                      (nickName.charCodeAt(i) > 64 &&
                        nickName.charCodeAt(i) < 91) ||
                      (nickName.charCodeAt(i) > 96 &&
                        nickName.charCodeAt(i) < 123)
                    )
                  ) {
                    setErrorNikName(
                      "Fields must not contain numbers or special characters"
                ...
                for (let i = 0; i < city.length; i++) {
                  if (
                    !(
                      ...
                      (city.charCodeAt(i) > 96 && city.charCodeAt(i) < 123)
                    )
                  ) {
                    setErrorCity(
                      "Fields must not contain numbers or special characters"
